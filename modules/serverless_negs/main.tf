...
resource "google_compute_backend_service" "default" {
  ...
  dynamic "cdn_policy" {
    ...
    content {
      ...
      signed_url_cache_max_age_sec = lookup(lookup(each.value, "cdn_config", {}), "default_ttl", null)
      ...
      serve_while_stale = lookup(lookup(each.value, "cdn_config", {}), "serve_while_stale", null)
    }
  }
